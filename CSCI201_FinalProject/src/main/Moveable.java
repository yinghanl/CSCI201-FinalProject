...
abstract class Moveable extends Thread implements Serializable{
	...
	public void move(int direction) throws BoundaryException{
		...
		try{
			...
			else if(currentLocation instanceof TowerSpace || currentLocation.isOccupied() || currentLocation instanceof MineableSpace && !(this instanceof Bullet) || currentLocation instanceof PathSpace && !(this instanceof Bullet)){
				throw new BoundaryException();
			}
			couldMove = true;
		}
